  ...
  return MultiRepositoryProvider(
    providers: [
      RepositoryProvider<GiveawayRepository>(
        create: (context) => GiveawayRepository(GiveawayDataProvider()),
      ),
      ...
      RepositoryProvider<LostAndFoundRepository>(
        create: (context) => LostAndFoundRepository(LostAndFoundDataProvider()),
      ),
      RepositoryProvider<NoticeRepository>(
        create: (context) => NoticeRepository(NoticeDataProvider()),
      ),
    ...
    child: MultiBlocProvider(
      providers: [
        BlocProvider<GiveawayBloc>(create: (context) {
          return GiveawayBloc(
              giveawayRepository: GiveawayRepository(GiveawayDataProvider()));
        }),
        ...
        BlocProvider<LostAndFoundBloc>(create: (context) {
          return LostAndFoundBloc(
            lostAndFoundRepository:
                LostAndFoundRepository(LostAndFoundDataProvider()),
          );
        }),
        BlocProvider<NoticeBloc>(create: (context) {
          return NoticeBloc(
              noticeRepository: NoticeRepository(NoticeDataProvider()),
              authBloc:
