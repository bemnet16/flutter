    ...
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
          ...
          onPressed: () {
            // Perform action on back arrow button press
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
               GoRouter.of(context).pushNamed(MyAppRouteConstants.giveawayRouteName);
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        height: 250.0,
                         child: giveaway.imageUrl!=null? Image.network(giveaway.imageUrl!,height: 250,fit: BoxFit.cover,): Container(),
                      ),
                      ...
                      GestureDetector(
                        onTap: () {
                          giveawayDetailBloc.add( FetchGiveawayEssay(
                              id: widget.id));
