    ...
    try {
      if (event.index == 0) {
        ...
        emit(UserLoaded(
            ...
            isPostLoading: false,
            giveaway: giveaway));
       userPrevState = UserLoaded(user: userPrevState!.user,giveaway:giveaway );
        ...
        emit(UserLoaded(
            ...
            isPostLoading: false,
            lostItems: lostItem));
        userPrevState = UserLoaded(user: userPrevState!.user,lostItems:lostItem );
        ...
        userPrevState = UserLoaded(user: userPrevState!.user,foundItems:foundItem );
      }
    } catch (e) {
      print(e);
      emit(UserLoadingFailed(error: e.toString()));
